...
public interface InformationMarketAPI {
    ...
    //公共-多空持仓人数比
    @GET("/api/information/v5/{currency}/long_short_ratio")
    ...
    //公共-持仓总量及交易量
    @GET("/api/information/v5/{currency}/volume")
    ...
    //公共-主动买入卖出情况
    @GET("/api/information/v5/{currency}/taker")
    ...
    //公共-多空精英趋向指标
    @GET("/api/information/v5/{currency}/sentiment")
    ...
    //公共-多空精英平均持仓比例
    @GET("/api/information/v5/{currency}/margin")
