...
public interface SwapMarketAPI {
    ...
    //公共-获取K线数据
    @GET("/api/swap/v5/instruments/{instrument_id}/candles")
    ...
    //公共-获取指数信息
    @GET("/api/swap/v5/instruments/{instrument_id}/index")
    Call<String> getIndexApi(@Path("instrument_id") String instrument_id);

    //公共-获取法币汇率
    @GET("/api/swap/v5/rate")
    Call<String> getRateApi();

    //公共-获取平台总持仓量
    @GET("/api/swap/v5/instruments/{instrument_id}/open_interest")
    Call<String> getOpenInterestApi(@Path("instrument_id") String instrument_id);

    //公共-获取当前限价
    @GET("/api/swap/v5/instruments/{instrument_id}/price_limit")
    Call<String> getPriceLimitApi(@Path("instrument_id") String instrument_id);

    //公共-获取强平单
    @GET("/api/swap/v5/instruments/{instrument_id}/liquidation")
