...
public interface SwapUserAPI {
    ...
    //获取所有订单列表
    @GET("/api/v5/swap/orders/{instrument_id}")
    ...
    //获取合约挂单冻结数量
    @GET("/api/v5/swap/accounts/{instrument_id}/holds")
    Call<String> getHolds(@Path("instrument_id") String instrument_id);

    //当前账户交易手续等级的费率
    @GET("/api/v5/swap/trade_fee")
