...
public interface SwapUserAPI {
    ...
    //获取所有订单列表
    @GET("/api/swap/v5/orders/{instrument_id}")
    ...
    //获取合约挂单冻结数量
    @GET("/api/swap/v5/accounts/{instrument_id}/holds")
    Call<String> getHolds(@Path("instrument_id") String instrument_id);

    //当前账户交易手续等级的费率
    @GET("/api/swap/v5/trade_fee")
