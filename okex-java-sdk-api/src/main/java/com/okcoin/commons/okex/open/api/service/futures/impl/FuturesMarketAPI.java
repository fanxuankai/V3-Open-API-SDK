...
interface FuturesMarketAPI {
    ...
    //公共-获取K线数据
    @GET("/api/v5/futures/instruments/{instrument_id}/candles")
    ...
    //公共-获取历史结算/交割记录
    @GET("/api/v5/futures/settlement/history")
    ...
    //公共-获取历史K线数据
    @GET("/api/v5/futures/instruments/{instrument_id}/history/candles")
    ...
    //获取服务时间
    @GET("/api/v5/general/time")
    Call<ServerTime> getServerTime();




  /*  @GET("/api/v5/futures/instruments/currencies")
